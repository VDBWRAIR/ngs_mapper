...
class Base(Base_):
    modulepath = 'miseqpipeline.coverage'
...
@patch('miseqpipeline.coverage.glob')
@patch('miseqpipeline.coverage.json')
...
class TestRefsFromProject(Base):
    ...
    @patch('miseqpipeline.coverage.load_project_qualdepth')
...
class TestGetPerreferenceFromProjects(Base):
    ...
    def setUp(self):
        ...
        from miseqpipeline.bqd import REGIONTYPES
    ...
    @raises(ValueError)
    @patch('miseqpipeline.coverage.glob',Mock(return_value=[]))
...
class TestCreateLegend(Base):
    ...
    @patch('miseqpipeline.coverage.Line2D')
...
class TestCreateFigureForProjects(Base):
    ...
    @patch('miseqpipeline.coverage.plt')
    @patch('miseqpipeline.coverage.get_allrefs')
    @patch('miseqpipeline.coverage.get_perreference_from_projects')
    @patch('miseqpipeline.coverage.set_figure_size')
    @patch('miseqpipeline.coverage.plot_all_references')
    @patch('miseqpipeline.coverage.create_legend')
    @patch('miseqpipeline.coverage.gridspec')
...
class TestMain(Base):
    ...
    @patch('miseqpipeline.coverage.gridspec',MagicMock())
    @patch('miseqpipeline.coverage.parse_args')
    @patch('miseqpipeline.coverage.plt')
