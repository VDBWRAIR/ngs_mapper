...
# Lazy import
from miseqpipeline.bqd import (
    G, N, LC, LQ, LCQ
)

class Base(BaseTester):
    modulepath = 'miseqpipeline.bqd'
...
class TestLines2dFromRegion(Base):
    ...
    def test_returns_generator(self):
        import types
        from miseqpipeline.bqd import CoverageRegion
        ok_(isinstance(
    ...
    def test_creates_correct_lines(self):
        from miseqpipeline.bqd import CoverageRegion, REGIONTYPES
        regions = [
