.. ngs_mapper documentation master file, created by
...
The ngs_mapper is a configurable pipeline next generation sequence pipeline that aims to be easy for the bioinformatician to install as well as use.
...
please open a bug report on `github <https://github.com/VDBWRAIR/ngs_mapper/issues>`_
...
.. toctree::
    ...
    pipeline
    scripts/index
    ngs_mapper api <ngs_mapper/modules>
    development
    todo
