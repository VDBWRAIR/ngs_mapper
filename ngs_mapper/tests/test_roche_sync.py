...
class BaseClass( BaseTester ):
    modulepath = 'ngs_mapper.roche_sync'
    ...
    def check_linkdemultiplexed( self, rdir ):
        ...
        '''
        from ngs_mapper.roche_sync import (
...
class TestSymlinkSigProc( BaseClass ):
    ...
    def test_creates_nonexisting_readdata( self ):
        from ngs_mapper.roche_sync import get_sigprocdir, sync
...
class TestLinkReads( BaseClass ):
    ...
    def setUp( self ):
        ...
        with patch('ngs_mapper.roche_sync.demultiplex_read',d_read) as dread:
            from ngs_mapper.roche_sync import demultiplex_run
...
@patch('ngs_mapper.roche_sync.demultiplex_read',d_read)
...
class TestGetSigProcDir( BaseClass ):
    ...
    def test_func( self ):
        from ngs_mapper.roche_sync import sync
